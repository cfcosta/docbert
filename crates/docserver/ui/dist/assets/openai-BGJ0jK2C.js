  ...
  o = class e extends a {
    constructor(t, n, r, i) {
      (super(`${e.makeMessage(t, n, r)}`),
        (this.status = t),
        (this.headers = i),
        (this.requestID = i?.get(`x-request-id`)),
        (this.error = n));
      let a = n;
    ...
    static generate(t, n, r, a) {
      if (!t || !a) return new c({ message: r, cause: i(n) });
      let o = n?.error;
      return t === 400
        ? new u(t, o, r, a)
        : t === 401
...
var ae = (e, t) => {
  ...
  w = `6.26.0`,
  ce = () => typeof window < `u` && window.document !== void 0 && typeof navigator < `u`;
function le() {
...
var xe = ({ headers: e, body: t }) => ({
  ...
  Se = `RFC3986`,
  Ce = (e) => String(e),
  we = { RFC1738: (e) => String(e).replace(/%20/g, `+`), RFC3986: Ce },
  Te = (e, t) => (
    (Te = Object.hasOwn ?? Function.prototype.call.bind(Object.prototype.hasOwnProperty)), Te(e, t)
  ),
  T = (() => {
    let e = [];
    for (let t = 0; t < 256; ++t)
  ...
  De = (e, t, n, r, i) => {
    ...
    for (let e = 0; e < a.length; e += Ee) {
      let t = a.length >= Ee ? a.slice(e, e + Ee) : a,
        n = [];
      for (let e = 0; e < t.length; ++e) {
        ...
        ((e += 1),
          (r = 65536 + (((r & 1023) << 10) | (t.charCodeAt(e) & 1023))),
          (n[n.length] =
            T[240 | (r >> 18)] +
            T[128 | ((r >> 12) & 63)] +
            T[128 | ((r >> 6) & 63)] +
...
function Fe(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _) {
  ...
  let S;
  if (n === `comma` && x(v))
    (h && c && (v = ke(v, c)), (S = [{ value: v.length > 0 ? v.join(`,`) || null : void 0 }]));
  else if (x(l)) S = l;
  else {
    let e = Object.keys(v);
    S = u ? e.sort(u) : e;
  ...
  let C = s ? String(t).replace(/\./g, `%2E`) : String(t),
    ne = r && x(v) && v.length === 1 ? C + `[]` : C;
  if (i && x(v) && v.length === 0) return ne + `[]`;
  for (let t = 0; t < S.length; ++t) {
    let y = S[t],
      ee = typeof y == `object` && y.value !== void 0 ? y.value : v[y];
    if (o && ee === null) continue;
    let C = d && s ? y.replace(/\./g, `%2E`) : y,
      re = x(v) ? (typeof n == `function` ? n(ne, C) : ne) : ne + (d ? `.` + C : `[` + C + `]`);
    _.set(e, b);
    let ie = new WeakMap();
    (ie.set(Pe, _),
      je(
...
function Ie(e = E) {
  if (e.allowEmptyArrays !== void 0 && typeof e.allowEmptyArrays != `boolean`)
    throw TypeError("`allowEmptyArrays` option can only be `true` or `false`, when provided");
  if (e.encodeDotInKeys !== void 0 && typeof e.encodeDotInKeys != `boolean`)
  ...
  if (e.charset !== void 0 && e.charset !== `utf-8` && e.charset !== `iso-8859-1`)
  ...
  if (
    ((a =
      e.arrayFormat && e.arrayFormat in Ae
        ? e.arrayFormat
        : `indices` in e
          ? e.indices
            ? `indices`
  ...
  return {
    ...
    allowDots: o,
    allowEmptyArrays:
      typeof e.allowEmptyArrays == `boolean` ? !!e.allowEmptyArrays : E.allowEmptyArrays,
    arrayFormat: a,
    charset: t,
    ...
    encodeValuesOnly:
      typeof e.encodeValuesOnly == `boolean` ? e.encodeValuesOnly : E.encodeValuesOnly,
    filter: i,
    format: n,
    formatter: r,
    ...
    strictNullHandling:
      typeof e.strictNullHandling == `boolean` ? e.strictNullHandling : E.strictNullHandling,
  };
}
function Le(e, t = {}) {
  let n = e,
  ...
  typeof r.filter == `function`
    ? ((a = r.filter), (n = a(``, n)))
    : x(r.filter) && ((a = r.filter), (i = a));
  let o = [];
  if (typeof n != `object` || !n) return ``;
  let s = Ae[r.arrayFormat],
  ...
  let u = o.join(r.delimiter),
    d = r.addQueryPrefix === !0 ? `?` : ``;
  return (
    r.charsetSentinel &&
      (r.charset === `iso-8859-1` ? (d += `utf8=%26%2310003%3B&`) : (d += `utf8=%E2%9C%93&`)),
    u.length > 0 ? d + u : ``
  );
}
function Re(e) {
    ...
    decode(n) {
      ...
      for (; (a = Ge(t(this, D, `f`), t(this, O, `f`))) != null; ) {
        ...
        if (t(this, O, `f`) != null && (a.index !== t(this, O, `f`) + 1 || a.carriage)) {
          (i.push(Ue(t(this, D, `f`).subarray(0, t(this, O, `f`) - 1))),
            e(this, D, t(this, D, `f`).subarray(t(this, O, `f`)), `f`),
            e(this, O, null, `f`));
          continue;
        }
        let n = t(this, O, `f`) === null ? a.preceding : a.preceding - 1,
          r = Ue(t(this, D, `f`).subarray(0, n));
        (i.push(r), e(this, D, t(this, D, `f`).subarray(a.index), `f`), e(this, O, null, `f`));
      }
      return i;
    }
    flush() {
      return t(this, D, `f`).length
        ? this.decode(`
`)
        : [];
    }
...
var qe = { off: 0, error: 200, warn: 300, info: 400, debug: 500 },
  Je = (e, t, n) => {
    if (e) {
      if (re(qe, e)) return e;
      k(n).warn(
        `${t} was set to ${JSON.stringify(e)}, expected one of ${JSON.stringify(Object.keys(qe))}`,
      );
    }
  };
function Ye() {}
...
var Ze = { error: Ye, warn: Ye, info: Ye, debug: Ye },
  Qe = new WeakMap();
function k(e) {
  let t = e.logger,
    n = e.logLevel ?? `off`;
...
var A = (e) => (
  ...
  et = class n {
    ...
    static fromSSEResponse(e, t, i, s) {
      ...
      async function* u() {
        if (c)
          throw new a("Cannot iterate over a consumed stream, use `.tee()` to split the stream.");
        c = !0;
        let n = !1;
        try {
          for await (let r of tt(e, t))
            if (!n) {
              ...
              if (r.event === null || !r.event.startsWith(`thread.`)) {
                ...
                try {
                  ...
                  throw (
                    l.error(`Could not parse message into JSON:`, r.data),
                    l.error(`From chunk:`, r.raw),
                    e
                  );
                }
                if (t && t.error) throw new o(void 0, t.error, void 0, e.headers);
                yield s ? { event: r.event, data: t } : t;
              } else {
                let e;
                try {
                  e = JSON.parse(r.data);
                  ...
                  throw (
                    console.error(`Could not parse message into JSON:`, r.data),
    ...
    [(($e = new WeakMap()), Symbol.asyncIterator)]() {
    ...
    tee() {
      ...
      return [
        new n(() => a(e), this.controller, t(this, $e, `f`)),
        new n(() => a(r), this.controller, t(this, $e, `f`)),
      ];
    }
    toReadableStream() {
      let e = this,
  ...
  if (!e.body)
    throw (
      ...
      globalThis.navigator !== void 0 && globalThis.navigator.product === `ReactNative`
        ...
        : new a(`Attempted to iterate over a response with no body`)
    );
  let n = new rt(),
    r = new We(),
    i = ye(e.body);
  for await (let e of nt(i))
...
async function* nt(e) {
  ...
  for await (let n of e) {
    if (n == null) continue;
    let e = n instanceof ArrayBuffer ? new Uint8Array(n) : typeof n == `string` ? Ve(n) : n,
...
async function at(e, t) {
  let { response: n, requestLogID: r, retryOfRequestLogID: i, startTime: a } = t,
    o = await (async () => {
      if (t.options.stream)
        return (
          k(e).debug(`response`, n.status, n.url, n.headers, n.body),
          t.options.__streamClass
            ? t.options.__streamClass.fromSSEResponse(
                n,
                t.controller,
                e,
                t.options.__synthesizeEventData,
              )
            : et.fromSSEResponse(n, t.controller, e, t.options.__synthesizeEventData)
        );
...
var st,
  ct = class n extends Promise {
    ...
    _thenUnwrap(e) {
      return new n(t(this, st, `f`), this.responsePromise, async (t, n) =>
        ot(e(await this.parseResponse(t, n), n), n.response),
      );
    }
    asResponse() {
    ...
    parse() {
      return (
        (this.parsedPromise ||= this.responsePromise.then((e) =>
          this.parseResponse(t(this, st, `f`), e),
        )),
        this.parsedPromise
      );
    }
...
var lt,
  ut = class {
    ...
    async *[((lt = new WeakMap()), Symbol.asyncIterator)]() {
  ...
  j = class extends ut {
    ...
    nextPageRequestOptions() {
      let e = this.getPaginatedItems(),
        t = e[e.length - 1]?.id;
      return t ? { ...this.options, query: { ...C(this.options.query), after: t } } : null;
    }
  },
  pt = class extends ut {
    constructor(e, t, n, r) {
    ...
    nextPageRequestOptions() {
      let e = this.last_id;
      return e ? { ...this.options, query: { ...C(this.options.query), after: e } } : null;
    }
  },
  mt = () => {
    if (typeof File > `u`) {
...
var _t = (e) => typeof e == `object` && !!e && typeof e[Symbol.asyncIterator] == `function`,
  vt = async (e, t) => (wt(e.body) ? { ...e, body: await xt(e.body, t) } : e),
  M = async (e, t) => ({ ...e, body: await xt(e.body, t) }),
  yt = new WeakMap();
function bt(e) {
...
var xt = async (e, t) => {
  ...
  St = (e) => e instanceof Blob && `name` in e,
  Ct = (e) => typeof e == `object` && !!e && (e instanceof Response || _t(e) || St(e)),
  wt = (e) => {
    if (Ct(e)) return !0;
  ...
  Tt = async (e, t, n) => {
    if (n !== void 0) {
      ...
      if (typeof n == `string` || typeof n == `number` || typeof n == `boolean`)
        ...
        await Promise.all(Object.entries(n).map(([n, r]) => Tt(e, `${t}[${n}]`, r)));
      else
        throw TypeError(
...
async function kt(e, t, n) {
  if ((mt(), (e = await e), Dt(e)))
    return e instanceof File ? e : ht([await e.arrayBuffer()], e.name);
  if (Ot(e)) {
    let r = await e.blob();
...
var Nt = Object.freeze(Object.create(null)),
  P = ((e = Mt) =>
    function (t, ...n) {
          ...
          return (
            o !== n.length &&
              (s == null ||
                (typeof s == `object` &&
                  s.toString ===
                    Object.getPrototypeOf(Object.getPrototypeOf(s.hasOwnProperty ?? Nt) ?? Nt)
                      ?.toString)) &&
              ((c = s + ``),
              i.push({
...
`)}\n${o}\n${t}`,
  ...
  Pt = class extends N {
    list(e, t = {}, n) {
      return this._client.getAPIList(P`/chat/completions/${e}/messages`, j, { query: t, ...n });
    }
  };
function Ft(e) {
      ...
      Wt(e.message.tool_calls),
      {
        ...
        message: {
          ...
          ...(e.message.tool_calls
            ? { tool_calls: e.message.tool_calls?.map((e) => Vt(t, e)) ?? void 0 }
            : void 0),
...
function Bt(e, t) {
  return e.response_format?.type === `json_schema` && e.response_format?.type === `json_schema`
...
function Ut(e) {
  return It(e.response_format)
    ? !0
    : (e.tools?.some((e) => Lt(e) || (e.type === `function` && e.function.strict === !0)) ?? !1);
}
function Wt(e) {
  for (let t of e || [])
    if (t.type !== `function`)
      throw new a(`Currently only \`function\` tool calls are supported; Received \`${t.type}\``);
}
function Gt(e) {
  for (let t of e ?? []) {
    if (t.type !== `function`)
...
var Kt = (e) => e?.role === `assistant`,
  ...
  sn = class {
    ...
    once(e, n) {
      return (
        (t(this, F, `f`)[e] || (t(this, F, `f`)[e] = [])).push({ listener: n, once: !0 }), this
      );
    }
    emitted(t) {
    ...
    _emit(n, ...r) {
      ...
      if (
        (i &&
          ((t(this, F, `f`)[n] = i.filter((e) => !e.once)),
          i.forEach(({ listener: e }) => e(...r))),
        n === `abort`)
      ) {
        let e = r[0];
        (!t(this, an, `f`) && !i?.length && Promise.reject(e),
          t(this, Zt, `f`).call(this, e),
          t(this, en, `f`).call(this, e),
          this._emit(`end`));
        return;
      }
      if (n === `error`) {
...
((Yt = new WeakMap()),
  ...
  (on = function (t) {
    if (
      (e(this, nn, !0, `f`),
      t instanceof Error && t.name === `AbortError` && (t = new s()),
      t instanceof s)
    )
      return (e(this, rn, !0, `f`), this._emit(`abort`, t));
  ...
  _n = class extends sn {
    ...
    _addMessage(e, t = !0) {
      if ((`content` in e || (e.content = null), this.messages.push(e), t)) {
        if ((this._emit(`message`, e), qt(e) && e.content))
          this._emit(`functionToolCallResult`, e.content);
        else if (Kt(e) && e.tool_calls)
          for (let t of e.tool_calls)
            t.type === `function` && this._emit(`functionToolCall`, t.function);
      }
    }
    ...
    _emitFinal() {
      ...
      (a != null && this._emit(`finalFunctionToolCallResult`, a),
        this._chatCompletions.some((e) => e.usage) &&
          this._emit(`totalUsage`, t(this, I, `m`, pn).call(this)));
    }
    ...
    async _runTools(e, n, r) {
      let i = `tool`,
        { tool_choice: o = `auto`, stream: s, ...c } = n,
        l = typeof o != `string` && o.type === `function` && o?.function?.name,
        { maxChatCompletions: u = gn } = r || {},
        d = n.tools.map((e) => {
          if (Lt(e)) {
            if (!e.$callback)
        ...
        f = {};
      for (let e of d)
        e.type === `function` && (f[e.function.name || e.function.function.name] = e.function);
      let p =
        `tools` in n
          ? d.map((e) =>
              e.type === `function`
      ...
      for (let n = 0; n < u; ++n) {
        let n = (
          await this._createChatCompletion(
            e,
            { ...c, tool_choice: o, tools: p, messages: [...this.messages] },
            r,
          )
        ).choices[0]?.message;
        ...
        for (let e of n.tool_calls) {
          ...
          let n = e.id,
            { name: r, arguments: a } = e.function,
            o = f[r];
          if (!o) {
            let e = `Invalid tool_call: ${JSON.stringify(r)}. Available options are: ${Object.keys(
              f,
            )
              .map((e) => JSON.stringify(e))
              .join(`, `)}. Please try again`;
            this._addMessage({ role: i, tool_call_id: n, content: e });
            continue;
          } else if (l && l !== r) {
          ...
          try {
            ...
            this._addMessage({ role: i, tool_call_id: n, content: t });
            continue;
          }
          let c = await o.function(s, this),
            u = t(this, I, `m`, hn).call(this, c);
          if ((this._addMessage({ role: i, tool_call_id: n, content: u }), l)) return;
        }
      }
    }
  };
((I = new WeakSet()),
  ...
  (un = function () {
    ...
    for (; e-- > 0; ) {
      ...
      if (Kt(t)) return { ...t, content: t.content ?? null, refusal: t.refusal ?? null };
    }
  ...
  (dn = function () {
    for (let e = this.messages.length - 1; e >= 0; e--) {
      let t = this.messages[e];
      if (Kt(t) && t?.tool_calls?.length)
        return t.tool_calls.filter((e) => e.type === `function`).at(-1)?.function;
    }
  }),
  (fn = function () {
    for (let e = this.messages.length - 1; e >= 0; e--) {
      ...
      if (
        ...
        this.messages.some(
          (e) =>
            e.role === `assistant` &&
            e.tool_calls?.some((e) => e.type === `function` && e.id === t.tool_call_id),
        )
      )
        return t.content;
    }
...
var vn = class e extends _n {
    static runTools(t, n, r) {
      let i = new e(),
        a = { ...r, headers: { ...r?.headers, "X-Stainless-Helper-Method": `runTools` } };
          ...
          : e[r] === `{`
            ...
            : e[r] === `[`
              ...
              : e.substring(r, r + 4) === `null` ||
                  (L.NULL & t && n - r < 4 && `null`.startsWith(e.substring(r)))
                ? ((r += 4), null)
                : e.substring(r, r + 4) === `true` ||
                    (L.BOOL & t && n - r < 4 && `true`.startsWith(e.substring(r)))
                  ? ((r += 4), !0)
                  : e.substring(r, r + 5) === `false` ||
                      (L.BOOL & t && n - r < 5 && `false`.startsWith(e.substring(r)))
                    ? ((r += 5), !1)
                    : e.substring(r, r + 8) === `Infinity` ||
                        (L.INFINITY & t && n - r < 8 && `Infinity`.startsWith(e.substring(r)))
                      ? ((r += 8), 1 / 0)
                      : e.substring(r, r + 9) === `-Infinity` ||
                        ...
                        : e.substring(r, r + 3) === `NaN` ||
                            (L.NAN & t && n - r < 3 && `NaN`.startsWith(e.substring(r)))
                          ? ((r += 3), NaN)
                          : u()
      ),
      s = () => {
  ...
  Gn = class n extends _n {
    ...
    async _fromReadableStream(e, n) {
      ...
      for await (let e of i)
        (a && a !== e.id && this._addChatCompletion(t(this, R, `m`, Hn).call(this)),
          t(this, R, `m`, zn).call(this, e),
          (a = e.id));
    ...
    (zn = function (e) {
      ...
      for (let r of e.choices) {
        ...
        (r.delta.content != null &&
          ...
          r.delta.refusal != null &&
            e.message?.role === `assistant` &&
            e.message?.refusal &&
            this._emit(`refusal.delta`, { delta: r.delta.refusal, snapshot: e.message.refusal }),
        ...
        e.finish_reason &&
          (t(this, R, `m`, Vn).call(this, e),
          i.current_tool_call_index != null &&
            t(this, R, `m`, Bn).call(this, e, i.current_tool_call_index));
        for (let n of r.delta.tool_calls ?? [])
          (i.current_tool_call_index !== n.index &&
            (t(this, R, `m`, Vn).call(this, e),
            i.current_tool_call_index != null &&
              t(this, R, `m`, Bn).call(this, e, i.current_tool_call_index)),
            (i.current_tool_call_index = n.index));
    ...
    (Vn = function (e) {
      ...
      (e.message.refusal &&
        !n.refusal_done &&
        ((n.refusal_done = !0), this._emit(`refusal.done`, { refusal: e.message.refusal })),
        e.logprobs?.content &&
          !n.logprobs_content_done &&
          ((n.logprobs_content_done = !0),
          this._emit(`logprobs.content.done`, { content: e.logprobs.content })),
        e.logprobs?.refusal &&
          !n.logprobs_refusal_done &&
          ((n.logprobs_refusal_done = !0),
          this._emit(`logprobs.refusal.done`, { refusal: e.logprobs.refusal })));
    }),
    (Hn = function () {
    ...
    (Wn = function (n) {
      ...
      let s = t(this, V, `f`),
        { choices: c, ...l } = n;
      s ? Object.assign(s, l) : (s = e(this, V, { ...l, choices: [] }, `f`));
      for (let { delta: e, finish_reason: c, index: l, logprobs: u = null, ...d } of n.choices) {
        let n = s.choices[l];
        if (
          ((n ||= s.choices[l] = { finish_reason: c, index: l, message: {}, logprobs: u, ...d }), u)
        )
          if (!n.logprobs) n.logprobs = Object.assign({}, u);
          else {
            let { content: e, refusal: t, ...a } = u;
            (Object.assign(n.logprobs, a),
              e && ((r = n.logprobs).content ?? (r.content = []), n.logprobs.content.push(...e)),
              t && ((i = n.logprobs).refusal ?? (i.refusal = []), n.logprobs.refusal.push(...t)));
          }
        ...
        if (
          (Object.assign(n.message, _),
          p && (n.message.refusal = (n.message.refusal || ``) + p),
          h && (n.message.role = h),
          m &&
            (n.message.function_call
              ? (m.name && (n.message.function_call.name = m.name),
                m.arguments &&
                  ((a = n.message.function_call).arguments ?? (a.arguments = ``),
                  (n.message.function_call.arguments += m.arguments)))
              : (n.message.function_call = m)),
          f &&
            ((n.message.content = (n.message.content || ``) + f),
            !n.message.refusal &&
              t(this, R, `m`, Un).call(this) &&
              (n.message.parsed = In(n.message.content))),
          g)
        ) {
          ...
          for (let { index: e, id: r, type: i, function: a, ...s } of g) {
            ...
            (Object.assign(c, s),
              r && (c.id = r),
              i && (c.type = i),
              a && (c.function ??= { name: a.name ?? ``, arguments: `` }),
              a?.name && (c.function.name = a.name),
              a?.arguments &&
                ((c.function.arguments += a.arguments),
                Ht(t(this, z, `f`), c) &&
                  (c.function.parsed_arguments = In(c.function.arguments))));
          }
        }
      }
      return s;
  ...
  return Rt(
    {
      ...
      choices: r.map(({ message: t, finish_reason: n, index: r, logprobs: i, ...o }) => {
        ...
        let { content: s = null, function_call: c, tool_calls: l, ...u } = t,
          d = t.role;
          ...
          ? {
              ...
              message: {
                ...
                tool_calls: l.map((t, n) => {
                  let { function: i, type: o, id: s, ...c } = t,
                    { arguments: l, name: u, ...d } = i || {};
                  if (s == null) throw new a(`missing choices[${r}].tool_calls[${n}].id\n${qn(e)}`);
                  if (o == null)
                    throw new a(`missing choices[${r}].tool_calls[${n}].type\n${qn(e)}`);
                  if (u == null)
                    throw new a(`missing choices[${r}].tool_calls[${n}].function.name\n${qn(e)}`);
                  if (l == null)
                    throw new a(
                      `missing choices[${r}].tool_calls[${n}].function.arguments\n${qn(e)}`,
                    );
                  return { ...c, id: s, type: o, function: { ...d, name: u, arguments: l } };
                }),
              },
            }
          : {
              ...o,
              message: { ...u, content: s, role: d, refusal: t.refusal ?? null },
              finish_reason: n,
              index: r,
              logprobs: i,
            };
...
var Jn = class e extends Gn {
  ...
  Yn = class extends N {
    ...
    update(e, t, n) {
      return this._client.post(P`/chat/completions/${e}`, { body: t, ...n });
    }
    list(e = {}, t) {
      return this._client.getAPIList(`/chat/completions`, j, { query: e, ...t });
    }
    delete(e, t) {
    ...
    parse(e, t) {
      return (
        ...
        this._client.chat.completions
          .create(e, {
            ...t,
            headers: { ...t?.headers, "X-Stainless-Helper-Method": `chat.completions.parse` },
          })
...
Xn.Completions = Yn;
var Zn = Symbol(`brand.privateNullableHeaders`);
function* Qn(e) {
  if (!e) return;
  if (Zn in e) {
  ...
  er = class extends N {
    create(e, t) {
      return this._client.post(
        ...
        M({ body: e, ...t, stream: e.stream ?? !1, __metadata: { model: e.model } }, this._client),
      );
    }
  },
  tr = class extends N {
    create(e, t) {
      return this._client.post(
        `/audio/translations`,
        M({ body: e, ...t, __metadata: { model: e.model } }, this._client),
      );
    }
  },
  nr = class extends N {
    constructor() {
      (super(...arguments),
        (this.transcriptions = new er(this._client)),
        (this.translations = new tr(this._client)),
        (this.speech = new $n(this._client)));
    }
  };
...
var rr = class extends N {
    ...
    list(e = {}, t) {
      return this._client.getAPIList(`/batches`, j, { query: e, ...t });
    }
    cancel(e, t) {
  ...
  sr = class extends N {
    constructor() {
      (super(...arguments),
        ...
        (this.transcriptionSessions = new or(this._client)));
    }
  };
...
var cr = class extends N {
  ...
  ur = class extends N {
    constructor() {
      (super(...arguments),
        (this.sessions = new cr(this._client)),
        (this.threads = new lr(this._client)));
    }
  };
...
var dr = class extends N {
  ...
  pr = (e) => {
    if (typeof Buffer < `u`) {
      ...
      return Array.from(
        new Float32Array(t.buffer, t.byteOffset, t.length / Float32Array.BYTES_PER_ELEMENT),
      );
    } else {
      let t = atob(e),
        n = t.length,
  ...
  Ar = class extends sn {
    ...
    async _createToolAssistantStream(e, n, r, i) {
      ...
      let o = { ...r, stream: !0 },
        c = await e.submitToolOutputs(n, o, { ...i, signal: this.controller.signal });
      this._connected();
    ...
    async _createThreadAssistantStream(e, n, r) {
      ...
      i &&
        ...
        i.addEventListener(`abort`, () => this.controller.abort()));
      let a = { ...n, stream: !0 },
        o = await e.createAndRun(a, { ...r, signal: this.controller.signal });
      this._connected();
    ...
    async _createAssistantStream(e, n, r, i) {
      ...
      a &&
        ...
        a.addEventListener(`abort`, () => this.controller.abort()));
      let o = { ...r, stream: !0 },
        c = await e.create(n, o, { ...i, signal: this.controller.signal });
      this._connected();
      for await (let e of c) t(this, W, `m`, xr).call(this, e);
      if (c.controller.signal?.aborted) throw new s();
      return this._addRun(t(this, W, `m`, Sr).call(this));
      ...
      for (let [n, r] of Object.entries(t)) {
        ...
        if (typeof t == `string` && typeof r == `string`) t += r;
          ...
          for (let e of r) {
            ...
            if (n == null)
              throw (
                console.error(e), Error("Expected array delta entry to have an `index` property")
              );
            if (typeof n != `number`)
              throw Error(
...
((G = Ar),
  (xr = function (n) {
    if (!this.ended)
      switch ((e(this, vr, n, `f`), t(this, W, `m`, Tr).call(this, n), n.event)) {
        case `thread.created`:
          break;
  ...
  (Cr = function (n) {
    ...
    switch (n.event) {
      ...
      case `thread.message.in_progress`:
        break;
      case `thread.message.delta`:
        if ((this._emit(`messageDelta`, n.data.delta, r), n.data.delta.content))
          for (let i of n.data.delta.content) {
  ...
  (wr = function (n) {
    ...
    switch ((e(this, br, r, `f`), n.event)) {
      ...
      case `thread.run.step.delta`:
        ...
        if (
          i.step_details &&
          i.step_details.type == `tool_calls` &&
          i.step_details.tool_calls &&
          r.step_details.type == `tool_calls`
        )
          for (let n of i.step_details.tool_calls)
            n.index == t(this, _r, `f`)
              ? this._emit(`toolCallDelta`, n, r.step_details.tool_calls[n.index])
              : (t(this, X, `f`) && this._emit(`toolCallDone`, t(this, X, `f`)),
                e(this, _r, n.index, `f`),
                e(this, X, r.step_details.tool_calls[n.index], `f`),
                t(this, X, `f`) && this._emit(`toolCallCreated`, t(this, X, `f`)));
      ...
      case `thread.run.step.expired`:
        (e(this, br, void 0, `f`),
          n.data.step_details.type == `tool_calls` &&
            t(this, X, `f`) &&
            (this._emit(`toolCallDone`, t(this, X, `f`)), e(this, X, void 0, `f`)),
          this._emit(`runStepDone`, n.data, r));
        break;
      case `thread.run.step.in_progress`:
        break;
    }
  ...
  (Er = function (e) {
    switch (e.event) {
      case `thread.run.step.created`:
        return ((t(this, K, `f`)[e.data.id] = e.data), e.data);
      case `thread.run.step.delta`:
  ...
  (Dr = function (e, n) {
    ...
    switch (e.event) {
      ...
      case `thread.message.delta`:
        ...
        let i = e.data;
        if (i.delta.content)
          for (let e of i.delta.content)
            if (e.index in n.content) {
...
var Mr = class extends N {
  constructor() {
    (super(...arguments),
      (this.runs = new jr(this._client)),
      (this.messages = new dr(this._client)));
  }
  create(e = {}, t) {
...
var Nr = class extends N {
  constructor() {
    (super(...arguments),
      (this.realtime = new sr(this._client)),
      (this.chatkit = new ur(this._client)),
      (this.assistants = new ir(this._client)),
      (this.threads = new Mr(this._client)));
  }
};
...
var Pr = class extends N {
  ...
  Ir = class extends N {
    ...
    create(e, t, n) {
      return this._client.post(P`/containers/${e}/files`, vt({ body: t, ...n }, this._client));
    }
    retrieve(e, t, n) {
      let { container_id: r } = t;
    ...
    list(e, t = {}, n) {
      return this._client.getAPIList(P`/containers/${e}/files`, j, { query: t, ...n });
    }
    delete(e, t, n) {
      let { container_id: r } = t;
...
var Lr = class extends N {
  ...
  list(e = {}, t) {
    return this._client.getAPIList(`/containers`, j, { query: e, ...t });
  }
  delete(e, t) {
...
var Rr = class extends N {
    ...
    retrieve(e, t, n) {
      ...
      return this._client.get(P`/conversations/${r}/items/${e}`, { query: i, ...n });
    }
    list(e, t = {}, n) {
      return this._client.getAPIList(P`/conversations/${e}/items`, pt, { query: t, ...n });
    }
    delete(e, t, n) {
  ...
  zr = class extends N {
    ...
    update(e, t, n) {
      return this._client.post(P`/conversations/${e}`, { body: t, ...n });
    }
    delete(e, t) {
...
var Br = class extends N {
    create(e, t) {
      let n = !!e.encoding_format,
        r = n ? e.encoding_format : `base64`;
      n && k(this._client).debug(`embeddings/user defined encoding_format:`, e.encoding_format);
      let i = this._client.post(`/embeddings`, { body: { ...e, encoding_format: r }, ...t });
      return n
        ? i
        : (k(this._client).debug(`embeddings/decoding base64 embeddings from base64`),
          i._thenUnwrap(
            (e) => (
              e &&
                e.data &&
  ...
  Vr = class extends N {
    ...
    list(e, t, n) {
      let { eval_id: r, ...i } = t;
      return this._client.getAPIList(P`/evals/${r}/runs/${e}/output_items`, j, { query: i, ...n });
    }
  },
  Hr = class extends N {
    constructor() {
    ...
    create(e, t, n) {
      return this._client.post(P`/evals/${e}/runs`, { body: t, ...n });
    }
    retrieve(e, t, n) {
      let { eval_id: r } = t;
    ...
    list(e, t = {}, n) {
      return this._client.getAPIList(P`/evals/${e}/runs`, j, { query: t, ...n });
    }
    delete(e, t, n) {
      let { eval_id: r } = t;
...
var Ur = class extends N {
  ...
  update(e, t, n) {
    return this._client.post(P`/evals/${e}`, { body: t, ...n });
  }
  list(e = {}, t) {
    return this._client.getAPIList(`/evals`, j, { query: e, ...t });
  }
  delete(e, t) {
...
var Wr = class extends N {
    create(e, t) {
      return this._client.post(`/files`, M({ body: e, ...t }, this._client));
    }
    retrieve(e, t) {
      return this._client.get(P`/files/${e}`, t);
    }
    list(e = {}, t) {
      return this._client.getAPIList(`/files`, j, { query: e, ...t });
    }
    delete(e, t) {
    ...
    async waitForProcessing(e, { pollInterval: t = 5e3, maxWait: n = 1800 * 1e3 } = {}) {
      ...
      for (; !a.status || !r.has(a.status); )
        if ((await se(t), (a = await this.retrieve(e)), Date.now() - i > n))
          throw new l({
...
var Jr = class extends N {
    ...
    retrieve(e, t = {}, n) {
      return this._client.get(P`/fine_tuning/checkpoints/${e}/permissions`, { query: t, ...n });
    }
    list(e, t = {}, n) {
...
var Xr = class extends N {
    list(e, t = {}, n) {
      return this._client.getAPIList(P`/fine_tuning/jobs/${e}/checkpoints`, j, { query: t, ...n });
    }
  },
  Zr = class extends N {
    constructor() {
    ...
    list(e = {}, t) {
      return this._client.getAPIList(`/fine_tuning/jobs`, j, { query: e, ...t });
    }
    cancel(e, t) {
      return this._client.post(P`/fine_tuning/jobs/${e}/cancel`, t);
    }
    listEvents(e, t = {}, n) {
      return this._client.getAPIList(P`/fine_tuning/jobs/${e}/events`, j, { query: t, ...n });
    }
    pause(e, t) {
...
var Z = class extends N {
  constructor() {
    (super(...arguments),
      (this.methods = new Gr(this._client)),
      (this.jobs = new Zr(this._client)),
      (this.checkpoints = new Yr(this._client)),
      (this.alpha = new qr(this._client)));
  }
};
...
var ei = class extends N {
    createVariation(e, t) {
      return this._client.post(`/images/variations`, M({ body: e, ...t }, this._client));
    }
    edit(e, t) {
      return this._client.post(
        `/images/edits`,
        M({ body: e, ...t, stream: e.stream ?? !1 }, this._client),
      );
    }
    generate(e, t) {
  ...
  ai = class extends N {
    constructor() {
      (super(...arguments),
        (this.clientSecrets = new ii(this._client)),
        (this.calls = new ri(this._client)));
    }
  };
...
function si(e, t) {
  let n = e.output.map((e) => {
      if (e.type === `function_call`) return { ...e, parsed_arguments: fi(t, e) };
      if (e.type === `message`) {
        let n = e.content.map((e) =>
          e.type === `output_text` ? { ...e, parsed: ci(t, e.text) } : e,
        );
        return { ...e, content: n };
      }
      return e;
  ...
  return (
    Object.getOwnPropertyDescriptor(e, `output_text`) || pi(r),
        ...
        for (let e of r.output)
          if (e.type === `message`) {
            for (let t of e.content)
              if (t.type === `output_text` && t.parsed !== null) return t.parsed;
          }
        return null;
      },
    }),
...
function ci(e, t) {
  return e.text?.format?.type === `json_schema`
    ? `$parseRaw` in e.text?.format
      ? (e.text?.format).$parseRaw(t)
      : JSON.parse(t)
    : null;
}
function li(e) {
...
function pi(e) {
  ...
  for (let n of e.output)
    if (n.type === `message`) for (let e of n.content) e.type === `output_text` && t.push(e.text);
...
var mi,
  ...
  xi = class n extends sn {
    ...
    static createResponse(e, t, r) {
      ...
      return (
        i._run(() =>
          i._createOrRetrieveResponse(e, t, {
            ...r,
            headers: { ...r?.headers, "X-Stainless-Helper-Method": `stream` },
          }),
        ),
    ...
    async _createOrRetrieveResponse(e, n, r) {
      ...
      (i &&
        (i.aborted && this.controller.abort(),
        i.addEventListener(`abort`, () => this.controller.abort())),
        t(this, mi, `m`, _i).call(this));
      let a,
        o = null;
      (`response_id` in n
        ? ((a = await e.responses.retrieve(
            n.response_id,
            { stream: !0 },
            { ...r, signal: this.controller.signal, stream: !0 },
          )),
          (o = n.starting_after ?? null))
        : (a = await e.responses.create(
            { ...n, stream: !0 },
            { ...r, signal: this.controller.signal },
          )),
        this._connected());
      ...
      switch ((r(`event`, e), e.type)) {
        case `response.output_text.delta`: {
          ...
          if (t.type === `message`) {
            ...
            if (n.type !== `output_text`)
              throw new a(`expected content to be 'output_text', got ${n.type}`);
        ...
        case `response.function_call_arguments.delta`: {
          ...
          t.type === `function_call` &&
            r(`response.function_call_arguments.delta`, { ...e, snapshot: t.arguments });
          break;
        }
        default:
          r(e.type, e);
    ...
    (bi = function (n) {
      ...
      switch (n.type) {
        ...
        case `response.content_part.added`: {
          ...
          let t = e.type,
            i = n.part;
          t === `message` && i.type !== `reasoning_text`
            ? e.content.push(i)
            : t === `reasoning` &&
              i.type === `reasoning_text` &&
              ((e.content ||= []), e.content.push(i));
          break;
        }
        case `response.output_text.delta`: {
          let e = r.output[n.output_index];
          ...
          if (e.type === `message`) {
            ...
            if (t.type !== `output_text`)
              throw new a(`expected content to be 'output_text', got ${t.type}`);
            t.text += n.delta;
          }
          break;
        }
        ...
        case `response.reasoning_text.delta`: {
          ...
          if (e.type === `reasoning`) {
            let t = e.content?.[n.content_index];
            if (!t) throw new a(`missing content at index ${n.content_index}`);
            if (t.type !== `reasoning_text`)
              throw new a(`expected content to be 'reasoning_text', got ${t.type}`);
            t.text += n.delta;
          }
          break;
        }
...
var Ci = class extends N {
    list(e, t = {}, n) {
      return this._client.getAPIList(P`/responses/${e}/input_items`, j, { query: t, ...n });
    }
  },
  wi = class extends N {
    count(e = {}, t) {
  ...
  Ti = class extends N {
    constructor() {
      (super(...arguments),
        (this.inputItems = new Ci(this._client)),
        (this.inputTokens = new wi(this._client)));
    }
    create(e, t) {
      return this._client
    ...
    retrieve(e, t = {}, n) {
      return this._client
        .get(P`/responses/${e}`, { query: t, ...n, stream: t?.stream ?? !1 })
        ._thenUnwrap((e) => (`object` in e && e.object === `response` && pi(e), e));
    }
    delete(e, t) {
...
var Ei = class extends N {
  ...
  Oi = class extends N {
    ...
    create(e, t = {}, n) {
      return this._client.post(P`/skills/${e}/versions`, vt({ body: t, ...n }, this._client));
    }
    retrieve(e, t, n) {
      let { skill_id: r } = t;
    ...
    list(e, t = {}, n) {
      return this._client.getAPIList(P`/skills/${e}/versions`, j, { query: t, ...n });
    }
    delete(e, t, n) {
      let { skill_id: r } = t;
...
var ki = class extends N {
  constructor() {
    (super(...arguments),
      (this.content = new Ei(this._client)),
      (this.versions = new Oi(this._client)));
  }
  create(e = {}, t) {
    return this._client.post(`/skills`, vt({ body: e, ...t }, this._client));
  }
  retrieve(e, t) {
    return this._client.get(P`/skills/${e}`, t);
  }
  update(e, t, n) {
    return this._client.post(P`/skills/${e}`, { body: t, ...n });
  }
  list(e = {}, t) {
    return this._client.getAPIList(`/skills`, j, { query: e, ...t });
  }
  delete(e, t) {
...
var Ai = class extends N {
    create(e, t, n) {
      return this._client.post(P`/uploads/${e}/parts`, M({ body: t, ...n }, this._client));
    }
  },
  ji = class extends N {
    constructor() {
    ...
    complete(e, t, n) {
      return this._client.post(P`/uploads/${e}/complete`, { body: t, ...n });
    }
  };
ji.Parts = Ai;
var Mi = async (e) => {
    let t = await Promise.allSettled(e),
      n = t.filter((e) => e.status === `rejected`);
    if (n.length) {
  ...
  Ni = class extends N {
    ...
    async poll(e, t, n) {
      ...
      for (;;) {
        let { data: i, response: a } = await this.retrieve(
          t,
          { vector_store_id: e },
          { ...n, headers: r },
        ).withResponse();
    ...
    async uploadAndPoll(e, { files: t, fileIds: n = [] }, r) {
      ...
      async function l(e) {
        for (let t of e) {
          let e = await o.files.create({ file: t, purpose: `assistants` }, r);
          c.push(e.id);
        }
      }
  ...
  Pi = class extends N {
    ...
    async poll(e, t, n) {
      ...
      for (;;) {
        let i = await this.retrieve(t, { vector_store_id: e }, { ...n, headers: r }).withResponse(),
          a = i.data;
        switch (a.status) {
          case `in_progress`:
            let e = 5e3;
    ...
    async upload(e, t, n) {
      let r = await this._client.files.create({ file: t, purpose: `assistants` }, n);
  ...
  Fi = class extends N {
    constructor() {
      (super(...arguments),
        (this.files = new Pi(this._client)),
        (this.fileBatches = new Ni(this._client)));
    }
    create(e, t) {
...
var Ii = class extends N {
    create(e, t) {
      return this._client.post(`/videos`, vt({ body: e, ...t }, this._client));
    }
    retrieve(e, t) {
      return this._client.get(P`/videos/${e}`, t);
    }
    list(e = {}, t) {
      return this._client.getAPIList(`/videos`, pt, { query: e, ...t });
    }
    delete(e, t) {
    ...
    remix(e, t, n) {
      return this._client.post(P`/videos/${e}/remix`, vt({ body: t, ...n }, this._client));
    }
  },
  Li,
  Ri,
  ...
  Bi = class extends N {
    ...
    async verifySignature(e, n, r = this._client.webhookSecret, i = 300) {
      ...
      let a = H([n]).values,
        o = t(this, Li, `m`, zi).call(this, a, `webhook-signature`),
        s = t(this, Li, `m`, zi).call(this, a, `webhook-timestamp`),
        c = t(this, Li, `m`, zi).call(this, a, `webhook-id`),
        l = parseInt(s, 10);
      ...
      let d = o.split(` `).map((e) => (e.startsWith(`v1,`) ? e.substring(3) : e)),
        f = r.startsWith(`whsec_`)
          ? Buffer.from(r.replace(`whsec_`, ``), `base64`)
          : Buffer.from(r, `utf-8`),
        p = c ? `${c}.${s}.${e}` : `${s}.${e}`,
        m = await crypto.subtle.importKey(`raw`, f, { name: `HMAC`, hash: `SHA-256` }, !1, [
          `verify`,
        ]);
      for (let e of d)
        try {
...
var Vi,
  ...
  $ = class {
    constructor({
      baseURL: t = U(`OPENAI_BASE_URL`),
      apiKey: n = U(`OPENAI_API_KEY`),
      organization: r = U(`OPENAI_ORG_ID`) ?? null,
      project: i = U(`OPENAI_PROJECT_ID`) ?? null,
      webhookSecret: o = U(`OPENAI_WEBHOOK_SECRET`) ?? null,
      ...s
    } = {}) {
      if (
        (Vi.add(this),
        Ui.set(this, void 0),
        (this.completions = new Pr(this)),
        (this.chat = new Xn(this)),
        (this.embeddings = new Br(this)),
        (this.files = new Wr(this)),
        (this.images = new ei(this)),
        (this.audio = new nr(this)),
        (this.moderations = new ni(this)),
        (this.models = new ti(this)),
        (this.fineTuning = new Z(this)),
        (this.graders = new $r(this)),
        (this.vectorStores = new Fi(this)),
        (this.webhooks = new Bi(this)),
        (this.beta = new Nr(this)),
        (this.batches = new rr(this)),
        (this.uploads = new ji(this)),
        (this.responses = new Ti(this)),
        (this.realtime = new ai(this)),
        (this.conversations = new zr(this)),
        (this.evals = new Ur(this)),
        (this.containers = new Lr(this)),
        (this.skills = new ki(this)),
        (this.videos = new Ii(this)),
        n === void 0)
      )
        throw new a(
      ...
      if (!c.dangerouslyAllowBrowser && ce())
...
`);
      ((this.baseURL = c.baseURL),
        (this.timeout = c.timeout ?? Hi.DEFAULT_TIMEOUT),
        (this.logger = c.logger ?? console));
      let l = `warn`;
      ((this.logLevel = l),
        (this.logLevel =
          Je(c.logLevel, `ClientOptions.logLevel`, this) ??
          Je(U(`OPENAI_LOG`), `process.env['OPENAI_LOG']`, this) ??
          l),
        (this.fetchOptions = c.fetchOptions),
        (this.maxRetries = c.maxRetries ?? 2),
        (this.fetch = c.fetch ?? ge()),
        e(this, Ui, xe, `f`),
        (this._options = c),
        (this.apiKey = typeof n == `string` ? n : `Missing Key`),
        (this.organization = r),
        (this.project = i),
        (this.webhookSecret = o));
    }
    withOptions(e) {
    ...
    async _callApiKey() {
      ...
      try {
        ...
        throw e instanceof a
          ? e
          : new a(`Failed to get token from 'apiKey' function: ${e.message}`, { cause: e });
      }
      if (typeof t != `string` || !t)
        throw new a(`Expected 'apiKey' function argument to return a string but it returned ${t}`);
      return ((this.apiKey = t), !0);
    }
    buildURL(e, n, r) {
      let i = (!t(this, Vi, `m`, Wi).call(this) && r) || this.baseURL,
        a = te(e)
          ? new URL(e)
          : new URL(i + (i.endsWith(`/`) && e.startsWith(`/`) ? e.slice(1) : e)),
        o = this.defaultQuery();
      return (
        ne(o) || (n = { ...o, ...n }),
        typeof n == `object` && n && !Array.isArray(n) && (a.search = this.stringifyQuery(n)),
        a.toString()
      );
    }
    ...
    async makeRequest(e, t, n) {
      let a = await e,
        o = a.maxRetries ?? this.maxRetries;
      ((t ??= o), await this.prepareOptions(a));
      let { req: u, url: d, timeout: f } = await this.buildRequest(a, { retryCount: o - t });
      await this.prepareRequest(u, { url: d, options: a });
      let p = `log_` + ((Math.random() * (1 << 24)) | 0).toString(16).padStart(6, `0`),
        m = n === void 0 ? `` : `, retryOf: ${n}`,
        h = Date.now();
      if (
        (k(this).debug(
          `[${p}] sending request`,
          A({ retryOfRequestLogID: n, method: a.method, url: d, options: a, headers: u.headers }),
        ),
        a.signal?.aborted)
      )
        throw new s();
      let g = new AbortController(),
        _ = await this.fetchWithTimeout(d, u, f, g).catch(i),
        v = Date.now();
      if (_ instanceof globalThis.Error) {
        ...
        if (t)
          return (
            k(this).info(`[${p}] connection ${i ? `timed out` : `failed`} - ${e}`),
            k(this).debug(
              `[${p}] connection ${i ? `timed out` : `failed`} (${e})`,
              A({ retryOfRequestLogID: n, url: d, durationMs: v - h, message: _.message }),
            ),
      ...
      let y = `[${p}${m}${[..._.headers.entries()]
        .filter(([e]) => e === `x-request-id`)
        .map(([e, t]) => `, ` + e + `: ` + JSON.stringify(t))
        .join(
          ``,
        )}] ${u.method} ${d} ${_.ok ? `succeeded` : `failed`} with status ${_.status} in ${v - h}ms`;
      if (!_.ok) {
        ...
        k(this).info(`${y} - ${r}`);
        let o = await _.text().catch((e) => i(e).message),
          s = oe(o),
          c = s ? void 0 : o;
        throw (
          k(this).debug(
    ...
    async fetchWithTimeout(e, t, n, r) {
      ...
      let c = setTimeout(s, n),
        ...
        u = { signal: r.signal, ...(l ? { duplex: `half` } : {}), method: `GET`, ...o };
      ...
      return ArrayBuffer.isView(e) ||
        ...
        : typeof e == `object` &&
          ...
          : typeof e == `object` &&
            ...
            : t(this, Ui, `f`).call(this, { body: e, headers: r });
    }
  };
((Hi = $),
  (Ui = new WeakMap()),
  ...
  ($.UnprocessableEntityError = h),
  ($.InvalidWebhookSignatureError = b),
  ($.toFile = kt),
  ($.Completions = Pr),
  ($.Chat = Xn),
  ($.Embeddings = Br),
...
var Gi = class extends $ {
    constructor({
      baseURL: e = U(`OPENAI_BASE_URL`),
      apiKey: t = U(`AZURE_OPENAI_API_KEY`),
      apiVersion: n = U(`OPENAI_API_VERSION`),
      endpoint: r,
      deployment: i,
      azureADTokenProvider: o,
      dangerouslyAllowBrowser: s,
      ...c
    } = {}) {
      if (!n)
        throw new a(
      ...
      if (((c.defaultQuery = { ...c.defaultQuery, "api-version": n }), !e)) {
        if (((r ||= {}.AZURE_OPENAI_ENDPOINT), !r))
          throw new a(
    ...
    async buildRequest(e, t = {}) {
      if (Ki.has(e.path) && e.method === `post` && e.body !== void 0) {
        ...
        t !== void 0 &&
          !this.baseURL.includes(`/deployments`) &&
          (e.path = `/deployments/${t}${e.path}`);
      }
      return super.buildRequest(e, t);
    }
    async authHeaders(e) {
      return typeof this._options.apiKey == `string`
